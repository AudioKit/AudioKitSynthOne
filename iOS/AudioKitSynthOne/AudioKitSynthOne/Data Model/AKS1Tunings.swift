...
class AKS1Tunings {
    ...
    private func loadTuningFactoryPresets() {
        AKLog("loading factory presets")
        for t in AKS1Tunings.defaultTunings() {
            let newTuning = AKS1Tuning()
            newTuning.name = t.0
            newTuning.masterSet = t.1() // return/compute masterSet
            AKLog("\(newTuning.encoding)")
    ...
    internal static func defaultTunings() -> [(String, AKS1TuningCallback)] {
        ...
        // do NOT include default tuning (12ET)...it will be added later
...
//        retVal.append( ("16 Harmonic+Sub", { return harmonicSubharmonicSeries(16) } ) )
        ...
        retVal.append( (" 6 Wilson Hexany(3, 2.111, 5.111, 8.111)", { return AKS1Tunings.hexany( [3, 2.111, 5.111, 8.111] ) } ) )
        retVal.append( (" 6 Wilson Hexany(3, 1.346, 4.346, 7.346)", { return AKS1Tunings.hexany( [3, 1.346, 4.346, 7.346] ) } ) )
        ...
        //(" 7 Wilson Diaphonic 1/1, 27/26, 9/8, 4/3, 18/13, 3/2, 27/16", { return [1/1, 27/26, 9/8, 4/3, 18/13, 3/2, 27/16] } ),

        retVal.append( (" 6 Wilson Hexany(3, 5, 15, 27) Maclellan Bagpipe", { return AKS1Tunings.hexany( [3, 5, 15, 27] ) } ) )
        retVal.append( ("10 Wilson Dekany(3, 5, 15, 27, 9) Maclellan Bagpipe", { return AKS1Tunings.dekany( [3, 5, 15, 27, 9] ) } ) )
        retVal.append( ("10 Wilson Dekany(3, 5, 15, 27, 25) Maclellan Bagpipe", { return AKS1Tunings.dekany( [3, 5, 15, 27, 25] ) } ) )
        ...
        retVal.append( ("31 Wilson MOS G: 0.328173 Hn = Hn-1 + Hn-7", { return [1.0, 1.139858796310911, 1.1521550874588165, 1.1645840255420112, 1.1771470414968035, 1.1898455816958056, 1.2026811081144566, 1.2156550984993382, 1.2287690465383074, 1.2420244620324628, 1.2554228710699677, 1.4310048026790014, 1.4464418478154171, 1.4620454209481724, 1.4778173185074355, 1.493759356302464, 1.5098733697306612, 1.5261612139888834, 1.5426247642870288, 1.5592659160639266, 1.5760865852055608, 1.7965161578941846, 1.8158961774201803, 1.8354852600014551, 1.8552856609175254, 1.8752996597768661, 1.8955295607793536, 1.915977692981552, 1.9366464105648538, 1.9575380931065183, 1.9786551458536268] } ) )
        retVal.append( ("22 Wilson Evangelina", { return [1.0 / 1, 135 / 128, 13 / 12, 10 / 9, 9 / 8, 7 / 6, 11 / 9, 5 / 4, 81 / 64, 4 / 3, 11 / 8, 45 / 32, 17 / 12, 3 / 2, 19 / 12, 13 / 8, 5 / 3, 27 / 16, 7 / 4, 11 / 6, 15 / 8, 243 / 128] } ) )
        ...
        retVal.append( (" 7 Wilson North Indian:Bhairav", { let t: AKTuningTable; _ = t.resetPersian17NorthIndian15Bhairav(); return t.masterSet } ) )
        ...
        retVal.append( ("22 Garcia: Wilson 7-limit marimba", {  return [1.0 / 1, 28 / 27, 16 / 15, 10 / 9, 9 / 8, 7 / 6, 6 / 5, 5 / 4, 35 / 27, 4 / 3, 27 / 20, 45 / 32, 35 / 24, 3 / 2, 14 / 9, 8 / 5, 5 / 3, 27 / 16, 7 / 4, 9 / 5, 15 / 8, 35 / 18] } ) )
        retVal.append( ("29 Garcia: linear 15/13-52/45 alternating", {  return [1.0 / 1, 40 / 39, 27 / 26, 16 / 15, 128 / 117, 9 / 8, 15 / 13, 32 / 27, 6 / 5, 16 / 13, 81 / 64, 135 / 104, 4 / 3, 160 / 117, 18 / 13, 64 / 45, 512 / 351, 3 / 2, 20 / 13, 81 / 52, 8 / 5, 64 / 39, 27 / 16, 45 / 26, 16 / 9, 9 / 5, 24 / 13, 405 / 208] } ) )

        /// scales designed by Kraig Grady
        retVal.append( (" 5 Grady: S 7-limit Pentatonic", {  return [1.0 / 1, 7 / 6, 4 / 3, 3 / 2, 7 / 4] } ) )
        retVal.append( (" 5 Grady: S Pentatonic 11-limit Scale 1", {  return [1.0 / 1, 9 / 8, 11 / 8, 3 / 2, 7 / 4] } ) )
        retVal.append( (" 5 Grady: S Pentatonic 11-limit Scale 2", {  return [1.0 / 1, 5 / 4, 11 / 8, 3 / 2, 7 / 4] } ) )
        retVal.append( (" 7 Grady: S Centaur 7-limit Minor", {  return [1.0 / 1, 9 / 8, 7 / 6, 4 / 3, 3 / 2, 14 / 9, 7 / 4] } ) )
        retVal.append( (" 7 Grady: S Centaur Soft Major on E", {  return [1.0 / 1, 28 / 25, 56 / 46, 4 / 3, 3 / 2, 42 / 25, 28 / 15] } ) )
        retVal.append( ("12 Grady: A Centaur", {  return [1.0 / 1, 21 / 20, 9 / 8, 7 / 6, 5 / 4, 4 / 3, 7 / 5, 3 / 2, 14 / 9, 5 / 3, 7 / 4, 15 / 8] } ) )
        retVal.append( ("14 Grady: Double Dekany 14-tone", {  return [1.0 / 1, 35 / 32, 9 / 8, 7 / 6, 5 / 4, 21 / 16, 45 / 32, 35 / 24, 3 / 2, 105 / 64, 5 / 3, 7 / 4, 15 / 8, 63 / 32] } ) )
        retVal.append( ("19 Grady: A-Narushima 19-tone 7-limit", {  return [1.0 / 1, 21 / 20, 35 / 32, 9 / 8, 7 / 6, 6 / 5, 5 / 4, 21 / 16, 4 / 3, 7 / 5, 35 / 24, 3 / 2, 14 / 9, 8 / 5, 5 / 3, 7 / 4, 9 / 5, 15 / 8, 63 / 32] } ) )
        retVal.append( ("12 Grady: Sisiutl 12-tone", {  return [ 1.0 / 1, 28 / 27, 9 / 8, 7 / 6, 14 / 11, 4 / 3, 11 / 8, 3 / 2, 14 / 9, 56 / 33, 7 / 4, 11 / 6] } ) )
        retVal.append( ("14 Grady: Wilson pre-Sisiutl 17", {  return [ 1.0 / 1, 28 / 27, 9 / 8, 7 / 6, 14 / 11, 4 / 3, 11 / 8, 3 / 2, 14 / 9, 3 / 2, 14 / 9, 56 / 33, 7 / 4, 11 / 6] } ) )
        retVal.append( ("12 Grady: Beebalm 7-limit", {  return [ 1.0 / 1, 17 / 16, 9 / 8, 7 / 6, 5 / 4, 4 / 3, 17 / 12, 3 / 2, 14 / 9, 5 / 3, 16 / 9, 17 / 9] } ) )
        retVal.append( ("12 Grady: Schulter Zeta Centauri 12 tone", {  return [ 1.0 / 1, 13 / 12, 9 / 8, 7 / 6, 11 / 9, 4 / 3, 13 / 9, 3 / 2, 14 / 9, 13 / 8, 7 / 4, 11 / 6] } ) )
        retVal.append( ("10 Grady: Shulter Shur", {  return [ 1.0 / 1, 27 / 26, 9 / 8, 27 / 22, 4 / 3, 18 / 13, 3 / 2, 18 / 11, 16 / 9, 24 / 13] } ) )
        retVal.append( ("17 Grady: Poole 17", {  return [ 1.0 / 1, 33 / 32, 13 / 12, 9 / 8, 7 / 6, 11 / 9, 14 / 11, 4 / 3, 11 / 8, 13 / 9, 3 / 2, 14 / 9, 44 / 27, 27 / 16, 7 / 4, 11 / 6, 21 / 11] } ) )
        retVal.append( ("10 Grady: 11-limit Helix Song", {  return [ 1.0 / 1, 9 / 8, 7 / 6, 5 / 4, 4 / 3, 11 / 8, 3 / 2, 5 / 3, 7 / 4, 11 / 6] } ) )
        //        ("14 Grady: 17-limit Helix Song", { return [ 1/1, 13/12, 9/8, 7/6, 5/4, 4/3, 11/8, 17/12, 3/2, 13/8, 5/3, 7/4, 11/6, 15/16] } ) )
        retVal.append( ("12 Grady: Gary David Double 1-3-5-7 Hexany 12-Tone", {  return [ 1.0 / 1, 16 / 15, 35 / 32, 7 / 6, 5 / 4, 4 / 3, 7 / 5, 35 / 24, 8 / 5, 5 / 3, 7 / 4, 28 / 15] } ) )
        retVal.append( ("12 Grady: Wilson Double Hexany+ 12 tone", {  return [ 1.0 / 1, 49 / 48, 8 / 7, 7 / 6, 5 / 4, 4 / 3, 10 / 7, 35 / 24, 80 / 49, 5 / 3, 7 / 4, 40 / 21] } ) )
        retVal.append( ("12 Grady: Wilson Triple Hexany +", {  return [ 1.0 / 1, 15 / 14, 9 / 8, 7 / 6, 5 / 4, 21 / 16, 10 / 7, 3 / 2, 45 / 28, 5 / 3, 7 / 4, 15 / 8] } ) )
        retVal.append( ("12 Grady: Wilson Super 7", {  return [ 1.0 / 1, 35 / 32, 8 / 7, 5 / 4, 245 / 192, 10 / 7, 35 / 24, 3 / 2, 49 / 32, 12 / 7, 7 / 4, 245 / 128] } ) )
        retVal.append( ("12 Grady: Gary David Dual Harmonic Subharmonic", {  return [ 1.0 / 1, 16 / 15, 9 / 8, 6 / 5, 9 / 7, 4 / 3, 7 / 5, 3 / 2, 8 / 5, 12 / 7, 9 / 5, 28 / 15] } ) )
        retVal.append( ("12 Grady: Wilson/David Enharmonics", {  return [ 1.0 / 1, 28 / 27, 9 / 8, 7 / 6, 6 / 5, 4 / 3, 35 / 24, 3 / 2, 14 / 9, 8 / 5, 7 / 4, 25 / 18] } ) )
        retVal.append( ("Grady: ****Wilson Meta Meantone (might need to check if it seems off)", { return  [ 1.0 / 1, 67 / 64, 558 / 512, 9 / 8, 75 / 64, 39 / 32, 5 / 4, 167 / 128, 87 / 64, 45 / 32, 187 / 128, 3 / 2, 25 / 16, 417 / 256, 27 / 16, 7 / 4, 233 / 128, 15 / 8, 125 / 64] } ) )
        retVal.append( (" 9 Grady: Wilson First Pelog", {  return [ 1.0 / 1, 16 / 15, 64 / 55, 5 / 4, 4 / 3, 16 / 11, 8 / 5, 128 / 75, 20 / 11] } ) )
        retVal.append( (" 9 Grady: Wilson Meta-Pelog 1", {  return [ 1.0 / 1, 571 / 512, 153 / 128, 41 / 32, 4 / 3, 11 / 8, 209 / 128, 7 / 4, 15 / 8] } ) )
        retVal.append( (" 9 Grady: Wilson Meta-Pelog 2", {  return [ 1.0 / 1, 9 / 8, 19 / 16, 41 / 32, 11 / 8, 3 / 2, 13 / 8, 7 / 4, 15 / 8] } ) )
        retVal.append( ("10 Grady: Wilson Meta-Ptolemy 10", {  return [ 1.0 / 1, 33 / 32, 9 / 8, 73 / 64, 5 / 4, 11 / 8, 3 / 2, 49 / 32, 27 / 16, 15 / 8] } ) )
        ...
        retVal.append( (" 5 Hobbs Recurrence Relation", { return [1, 19, 5, 3, 15] } ) )
        retVal.append( (" 5 Hobbs Recurrence Relation", { return [35, 74, 23, 51, 61] } ) )
        retVal.append( (" 6 Hobbs Recurrence Relation", { return  [74, 150, 85, 106, 120, 61] } ) )
        retVal.append( (" 6 Hobbs Recurrence Relation", { return  [1, 9, 5, 23, 48, 7] } ) )
        retVal.append( (" 6 Hobbs Recurrence Relation", { return  [1, 9, 21, 3, 25, 15] } ) )
        retVal.append( (" 6 Hobbs Recurrence Relation", { return  [1, 75, 19, 5, 3, 15] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [1, 17, 10, 47, 3, 13, 7] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [1, 9, 5, 21, 3, 27, 7] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [1, 9, 21, 3, 25, 15, 31] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [1, 75, 19, 5, 94, 3, 15] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [9, 40, 21, 25, 52, 15, 31] } ) )
        retVal.append( (" 7 Hobbs Recurrence Relation", { return  [1, 18, 5, 21, 3, 25, 15] } ) )
        retVal.append( ("12 Hobbs Recurrence Relation", { return  [1, 65, 9, 37, 151, 21, 86, 12, 49, 200, 28, 114] } ) )
        ...
        retVal.append( ("27 Taylor Pasadena JI 27", { return [ 1.0 / 1, 81 / 80, 17 / 16, 16 / 15, 10 / 9, 9 / 8, 8 / 7, 7 / 6, 19 / 16, 6 / 5, 11 / 9, 5 / 4, 9 / 7, 21 / 16, 4 / 3, 11 / 8, 7 / 5, 3 / 2, 11 / 7, 8 / 5, 5 / 3, 13 / 8, 27 / 16, 7 / 4, 9 / 5, 11 / 6, 15 / 8 ] } ) )

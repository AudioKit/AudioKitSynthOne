...
//        { index2,                0, 0, 1, "index2", "Index 2", kAudioUnitParameterUnit_Generic},
        ...
        { cutoffLFO,             0, 0, 2, "cutoffLFO", "cutoffLFO", kAudioUnitParameterUnit_Generic},
        { resonanceLFO,          0, 0, 2, "resonanceLFO", "resonanceLFO", kAudioUnitParameterUnit_Generic},
        { oscMixLFO,             0, 0, 2, "oscMixLFO", "oscMixLFO", kAudioUnitParameterUnit_Generic},
        { sustainLFO,            0, 0, 2, "sustainLFO", "sustainLFO", kAudioUnitParameterUnit_Generic},
        { decayLFO,              0, 0, 2, "decayLFO", "decayLFO", kAudioUnitParameterUnit_Generic},
        { noiseLFO,              0, 0, 2, "noiseLFO", "noiseLFO", kAudioUnitParameterUnit_Generic},
        { fmLFO,                 0, 0, 2, "fmLFO", "fmLFO", kAudioUnitParameterUnit_Generic},
        { detuneLFO,             0, 0, 2, "detuneLFO", "detuneLFO", kAudioUnitParameterUnit_Generic},
        { filterEnvLFO,          0, 0, 2, "filterEnvLFO", "filterEnvLFO", kAudioUnitParameterUnit_Generic},
        { pitchLFO,              0, 0, 2, "pitchLFO", "pitchLFO", kAudioUnitParameterUnit_Generic},
        { bitcrushLFO,           0, 0, 2, "bitcrushLFO", "bitcrushLFO", kAudioUnitParameterUnit_Generic},
        { autopanLFO,            0, 0, 2, "autopanLFO", "autopanLFO", kAudioUnitParameterUnit_Generic},

...
extension ParentViewController {
    ...
    func loadPreset() {
        ...
        s.setAK1Parameter(.filterAttackDuration, activePreset.filterAttackDuration)
        s.setAK1Parameter(.filterDecayDuration, activePreset.filterDecayDuration)
        s.setAK1Parameter(.filterSustainLevel, activePreset.filterSustainLevel)
        s.setAK1Parameter(.filterReleaseDuration, activePreset.filterReleaseDuration)
    ...
    func saveValuesToPreset() {
        ...
        activePreset.filterAttackDuration = s.getAK1Parameter(.filterAttackDuration)
        activePreset.filterDecayDuration = s.getAK1Parameter(.filterDecayDuration)
        activePreset.filterSustainLevel = s.getAK1Parameter(.filterSustainLevel)
        activePreset.filterReleaseDuration = s.getAK1Parameter(.filterReleaseDuration)

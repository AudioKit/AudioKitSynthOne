...
class AKS1Tunings {
    ...
    var tuningsDelegate: TuningsPitchWheelViewTuningDidChange? = nil
...
//        (" 5 Hobbs Recurrence Relation", { _ = AKPolyphonicNode.tuningTable.tuningTable(fromFrequencies: [1, 37, 21, 49, 28]) }),
        ...
        (" 5 SJT MOS G: 0.618033", {_ = AKPolyphonicNode.tuningTable.momentOfSymmetry(generator: 0.618033, level: 4, murchana: 0 ) } ),
        (" 5 SJT MOS G: 0.232587", {_ = AKPolyphonicNode.tuningTable.momentOfSymmetry(generator: 0.232587, level: 5, murchana: 0 ) } ),

...
class WheelSettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
		...
		modWheelSegment.subviews[1].accessibilityLabel = NSLocalizedString("L F O 1", comment: "LFO 1 (Word is separated for proper VoiceOver pronunciation.  Do not consider for localization.)")
		modWheelSegment.subviews[2].accessibilityLabel = NSLocalizedString("L F O 2", comment: "LFO 2 (Word is separated for proper VoiceOver pronunciation.  Do not consider for localization.)")

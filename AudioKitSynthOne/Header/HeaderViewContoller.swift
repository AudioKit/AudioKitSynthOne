    ...
    func updateDisplayLabel(_ parameter: S1Parameter, value: Double) {
        ...
        switch parameter {
            ...
            case .arpRate:
                ...
                displayLabel.text = message
            case .arpOctave:
                displayLabel.text = "Arpeggiator Octave: \(Int(value))"
            case .arpDirection:
                var arpDirDesc = ""
                switch value {
                    case 0:
                        arpDirDesc = "Arp Style: Up"
                    case 1:
                        arpDirDesc = "Arp Style: Up+Down"
                    case 2:
                        arpDirDesc = "Arp Style: Down"
                    default:
                        arpDirDesc = ".arpDirection: error: \(value)"
                }
                displayLabel.text = arpDirDesc
            case .arpTotalSteps:
                displayLabel.text = "Arp Steps: \(Int(value))"
            case .widen:

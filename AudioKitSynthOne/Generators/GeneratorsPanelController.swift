...
class GeneratorsPanelController: PanelController {
    ...
    public override func viewDidLoad() {
		...
		view.accessibilityElements = [
			morph1Selector as Any,
			morph1SemitoneOffset as Any,
			morph2Selector as Any,
			morph2SemitoneOffset as Any,
			morph2Detuning as Any,
			subVolume as Any,
			subOctaveDown as Any,
			subIsSquare as Any,
			morph1Volume as Any,
			morph2Volume as Any,
			morphBalance as Any,
			...
			fmVolume as Any,
			fmAmount as Any,
			filterTypeToggle as Any,
			cutoff as Any,
			resonance as Any,
			noiseVolume as Any,
			glideKnob as Any,
			isMonoToggle as Any,
			legatoModeToggle as Any,
			oscBandlimitEnable as Any,
			widenToggle as Any,

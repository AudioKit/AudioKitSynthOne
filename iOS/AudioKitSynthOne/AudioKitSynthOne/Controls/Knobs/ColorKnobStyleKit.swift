...
public class ColorKnobStyleKit : NSObject {
    ...
    @objc dynamic public class func drawFMKnob(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 124), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.496, knobTopColor: UIColor) {
        ...
        let shadow = NSShadow()
        shadow.shadowColor = medium
        shadow.shadowOffset = CGSize(width: 0, height: 0)
        shadow.shadowBlurRadius = 8
        let shadow4 = NSShadow()
        shadow4.shadowColor = medium
        shadow4.shadowOffset = CGSize(width: 0, height: -5)
        shadow4.shadowBlurRadius = 16
        ...
        //// topCircle Drawing
        let topCirclePath = UIBezierPath(ovalIn: CGRect(x: 31, y: 30, width: 67, height: 67))
        knobTopColor.setFill()
        topCirclePath.fill()

        ////// topCircle Inner Shadow
        context.saveGState()
        context.clip(to: topCirclePath.bounds)
        context.setShadow(offset: CGSize.zero, blur: 0)
        context.setAlpha((shadow4.shadowColor as! UIColor).cgColor.alpha)
        context.beginTransparencyLayer(auxiliaryInfo: nil)
        let topCircleOpaqueShadow = (shadow4.shadowColor as! UIColor).withAlphaComponent(1)
        context.setShadow(offset: CGSize(width: shadow4.shadowOffset.width * resizedShadowScale, height: shadow4.shadowOffset.height * resizedShadowScale), blur: shadow4.shadowBlurRadius * resizedShadowScale, color: topCircleOpaqueShadow.cgColor)
        context.setBlendMode(.sourceOut)
        context.beginTransparencyLayer(auxiliaryInfo: nil)

        topCircleOpaqueShadow.setFill()
        topCirclePath.fill()
        ...
        let indicatorPath = UIBezierPath(rect: CGRect(x: -2.32, y: -44.82, width: 6, height: 35))
        context.saveGState()

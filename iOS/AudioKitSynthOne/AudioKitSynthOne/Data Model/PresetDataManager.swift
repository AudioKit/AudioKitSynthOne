...
extension ParentViewController {
    ...
    func loadPreset() {
        ...
        s.setAK1Parameter(.index1LFO, activePreset.index1LFO)
        s.setAK1Parameter(.index2LFO, activePreset.index2LFO)
    ...
    func saveValuesToPreset() {
        ...
        activePreset.index1LFO = s.getAK1Parameter(.index1LFO)
        activePreset.index2LFO = s.getAK1Parameter(.index2LFO)

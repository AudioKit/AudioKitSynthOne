...
class AKS1Tunings {
    ...
    public let tunings: [(String, AKS1TuningCallback)] = [
        ...
        ("Grady: 11-limit Helix Song", {tuningHelper( [ 1/1, 9/8, 7/6, 5/4, 4/3, 11/8, 3/2, 5/3, 7/4, 11/6] ) } ),
        ...
        ("Grady: Gary David Dual Harmonic Subharmonic", {tuningHelper( [ 1/1, 16/15, 9/8, 6/5, 9/7, 4/3, 7/5, 3/2, 8/5, 12/7, 9/5, 28/15] ) } ),
        ("Grady: Wilson/David Enharmonics", {tuningHelper( [ 1/1, 28/27, 9/8, 7/6, 6/5, 4/3, 35/24, 3/2, 14/9, 8/5, 7/4, 25/18] ) } ),
        ...
        ("Grady: wilson Meta-Ptolemy 10", {tuningHelper( [ 1/1, 33/32, 9/8, 73/64, 5/4, 11/8, 3/2, 49/32, 27/16, 15/8] ) } ),

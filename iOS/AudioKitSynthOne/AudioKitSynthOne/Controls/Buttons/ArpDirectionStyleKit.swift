...
//  AudioKitSynthOne
//
//  Created by Matthew Fecher on 11/28/17.
...
public class ArpDirectionStyleKit : NSObject {
    ...
    @objc dynamic public class func drawArpDirectionButton(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 109, height: 37), resizing: ResizingBehavior = .aspectFit, directionSelected: CGFloat = 2) {
        ...
        //// Button
        //// up Drawing
        let upPath = UIBezierPath(roundedRect: CGRect(x: 0.5, y: 2, width: 35, height: 32), cornerRadius: 1)
        upSelected.setFill()
        upPath.fill()
        ...
        //// down Drawing
        let downPath = UIBezierPath(roundedRect: CGRect(x: 70.5, y: 2, width: 35, height: 32), cornerRadius: 1)
        downSeleted.setFill()
        downPath.fill()
        UIColor.black.setStroke()
        ...
        //// up_down Drawing
        let up_downPath = UIBezierPath(roundedRect: CGRect(x: 35.5, y: 2, width: 35, height: 32), cornerRadius: 1)
        ...
        //// Rectangle 2 Drawing
        context.saveGState()
        context.translateBy(x: 49.62, y: 5.7)
        context.rotate(by: 90 * CGFloat.pi/180)
        ...
        //// Rectangle 4 Drawing
        context.saveGState()
        context.translateBy(x: 18.12, y: 10.7)
        context.rotate(by: 90 * CGFloat.pi/180)

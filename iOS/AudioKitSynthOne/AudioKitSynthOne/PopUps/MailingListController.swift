...
class MailingListController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func closePressed(_ sender: UIButton) {
        ...
        let submitAction = UIAlertAction(title: "WAIT! Take me back 👍🏼", style: .default) { (action: UIAlertAction) in
    ...
    func signUpAction() {
        ...
        let alert = UIAlertController(title: "Almost Done",
            ...
            preferredStyle: .alert)
        let submitAction = UIAlertAction(title: "Yes, that is correct 👍🏼", style: .default) { (action: UIAlertAction) in
        ...
        let cancelAction = UIAlertAction(title: "Oops, Go back", style: .default) { (action: UIAlertAction) in
        }
